            ...
            Wind.use('ajaxForm', 'validate', function () {
                ...
                $('button.js-ajax-submit').on('click', function (e) {
                    ...
                    if (msg) {
                        ...
                        layer.confirm(btn.data('msg'), {icon: 0, title: '提示', offset: '100px'}, function (index) {
                            btn.data('msg', false);
                            btn.click();
                            ...
                            $form.ajaxSubmit({
                                ...
                                success: function (data, statusText, xhr, $form) {
                                    ...
                                    if (data.code == 1) {
                                        ...
                                        layer.msg(data.msg, {time: 1200, offset: '100px'}, function () {
                    ...
                    yes: function (index, layero) {
                        $.getJSON(href).done(function (data) {
                            if (data.code == '1') {
                                ...
                                layer.confirm(data.msg, {title: data.msg}, function (index) {
                                    layer.close(index);
                                    return true;
                                });
                            }
