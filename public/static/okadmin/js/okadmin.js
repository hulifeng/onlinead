layui.use(['element', 'layer', 'okUtils', 'okTab'], function () {
    ...
    $(".layui-footer button.donate").click(function () {
        layer.tab({
            ...
            tab: [{
                title: "支付宝",
                content: "<img src='/static/admin/images/zfb.jpg' width='200' height='300' style='margin-left: 60px'>"
            }, {
                title: "微信",
                content: "<img src='/static/admin/images/wx.jpg' width='200' height='300' style='margin-left: 60px'>"
            }]
        });
    });
    ...
    $("body").on("click", ".layui-footer button.communication,#noticeQQ", function () {
        layer.tab({
            ...
            tab: [{
                title: "QQ群",
                content: "<img src='/static/admin/images/qq.jpeg' width='200' height='300' style='margin-left: 60px'>"
            }]
        });
    });
    ...
    $("#logout").click(function () {
        layer.confirm("确定要退出吗？", {skin: 'layui-layer-lan', icon: 3, title: '提示', anim: 6}, function () {
            window.location = "/index.php?s=/Admin/Public/logout";
        });
    });
